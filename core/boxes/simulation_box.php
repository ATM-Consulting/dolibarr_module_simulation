 ...
 */
class simulationbox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "simulation@simulation";
    public $boxlabel;
    public $depends = array("simulation");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/simulation/class/simulation.class.php";
